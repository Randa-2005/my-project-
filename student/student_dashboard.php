...
// ========== ✅ حساب عدد الأحزاب بناءً على آخر آية وجدول parts ==========
$current_surah_name = $progress['current_surah'] ?? 'الفاتحة';
$current_ayah = $progress['current_ayah'] ?? 0;

// عدد الأحزاب المحفوظة (الحصص التي أكملها الطالب)
$stmt = $conn->prepare("
...
$memorized_parts = $parts_result['completed_parts'] ?? 0;

// عدد الأجزاء (كل جزئين = حزب)
