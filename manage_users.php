...
<head>
    <meta charset="UTF-8">
    <title>الإدارة والرقابة - مدرسة أسرتي القرآنية</title>
    ...
    <style>
        ...
        .user-table th { background-color: var(--primary-green); color: var(--gold); padding: 15px; text-align: right; }
        .user-table td { background-color: white; padding: 15px; }
    </style>
</head>
<body>
    ...
    <main class="main-content">
        <div class="ornamental-card">
            <h2 class="section-title"><i class="fas fa-user-shield"></i> إدارة المستخدمين والرقابة</h2>
            <p>هنا يمكنك التحكم في صلاحيات الوصول ومراقبة النظام.</p>
            
            <table class="user-table">
                <thead>
                    <tr>
                        <th style="border-radius: 0 10px 10px 0;">اسم المستخدم</th>
                        <th>الصلاحية</th>
                ...
                <tbody>
                    <tr>
                        <td style="font-weight: bold;">المدير العام</td>
                        <td>إدارة كاملة</td>
                        <td><i class="fas fa-edit" style="color: var(--primary-green);"></i></td>
                    </tr>
                </tbody>
            </table>
        </div>
