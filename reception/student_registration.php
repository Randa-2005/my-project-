...
<main class="main-content">
    ...
    <div class="registration-form-container">
        ...
        <form id="regForm">
            ...
            <div id="priceDisplay" style="display:none; background:#e8f5e9; padding:10px; border-radius:8px; margin:10px 0; text-align:center;">
...
document.getElementById('submitBtn').onclick = function() {
    ...
    .then(data => {
        if(!data.success) {
            console.log('خطأ في الحفظ: ' + data.message);
        }
    })
    .catch(error => {
