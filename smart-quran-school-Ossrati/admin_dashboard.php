...
$result = mysqli_query($conn, $sql);<?php
include 'db_connect.php'; // هذا السطر يجعلكِ متصلة بقاعدة البيانات فوراً

// الآن يمكنكِ كتابة أوامر الـ SQL (مثل SELECT أو INSERT)
?>
?><!DOCTYPE html>
